...
import * as RequestMapper from './SigoutourReqMapper'
...
const buildTaxInfo = (jsonData) => {
    ...
    const deductionTypeValue = parseInt(jsonData.deductionType)
    const deductionType = DEDUCTION_TYPE[deductionTypeValue]
    const deductionType2 = DEDUCTION_TYPE[deductionType12Map[deductionTypeValue]]
